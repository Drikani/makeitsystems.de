...
- [_includes/resume/](_includes/resume) and [_includes/imprint/](_includes/imprint) hold sub-includes for each section (e.g. `hardskills.html`, `softskills.html`, `timeline.html`; `imprint.html`, `SSL.html`, `cookies.html`, `disclaimer.html`, `rights.html`, `logs.html`, `ads.html`, `linkedin.html`, `source.html`) — pulled in by the corresponding top-level include.
