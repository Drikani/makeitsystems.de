...
- [_layouts/default.html](_layouts/default.html) is the only layout. It assembles `head`, `header`, `nav`, page `content`, and `footer` includes, then loads jQuery/cookiepopup JS at the bottom of `<body>`.
